...
func (r *queryResolver) Logs(ctx context.Context, projectID int, cursor *string, params modelInputs.LogsParamsInput, after *string, before *string) (*modelInputs.LogsConnection, error) {
	project, err := r.isAdminInProject(ctx, projectID)
	if err != nil {
		return nil, e.Wrap(err, "error querying project")
	}
