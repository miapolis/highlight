...
export const useGetLogs = ({query, project_id, log_cursor, startDate, endDate }: {query: string, project_id: string | undefined, log_cursor: string | undefined, startDate: Date, endDate: Date}) => {
    ...
    const [getLogs, { loading: logsLoading, error: logsError, fetchMore}]  = useGetLogsLazyQuery({
		variables: {
